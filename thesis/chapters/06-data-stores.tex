...
In conclusion, the data stores included in the study will be MongoDB and CouchDB as document databases, and Neo4j as graph database.
...
Two type of locks exist in this context: \TODO{mutual} locks (colloquially known as \textit{reader locks}), and exclusive locks (\textit{writer locks}).
