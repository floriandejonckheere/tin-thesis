...
\input{chapters/04-overview}
\input{chapters/05-methodology}
\input{chapters/06-data-stores}
\input{chapters/07-data-model}
\input{chapters/08-comparative-study}
\input{chapters/09-opportunities}
...
\input{../proposal/proposal-contents}
