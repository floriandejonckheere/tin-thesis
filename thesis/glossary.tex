...
description = {Consistency model where all access to a piece of data will eventually return the last updated value},
}
...
\newglossaryentry{index-free-adjacency}{
name = $index-free adjacency$,
description = {Technique used in graph databases where every node contains logical pointers to their neighbour nodes},
}
